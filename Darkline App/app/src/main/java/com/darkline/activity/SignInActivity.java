...
//            UserApi userApi = retrofitService.getRetrofitClientWithoutToken().create(UserApi.class);
            ...
            RagisterBtn.setOnClickListener(view -> {
                ...
                Call<User> callWithoutToken = apiServiceWithoutToken.createUser(user);

                callWithoutToken.enqueue(new Callback<User>() {
                            @Override
